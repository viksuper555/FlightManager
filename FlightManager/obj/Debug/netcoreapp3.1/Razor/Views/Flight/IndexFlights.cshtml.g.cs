#pragma checksum "C:\Users\viksu\Source\Repos\viksuper555\FlightManagerRepo\FlightManager\Views\Flight\IndexFlights.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "452ed8473293e55f1f7f89e33de5b87c5d272c39"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"452ed8473293e55f1f7f89e33de5b87c5d272c39", @"/Views/Flight/IndexFlights.cshtml")]
...
#nullable disable
     ...
     ");
            WriteLiteral(@"       var plane = labelsContainer.createChild(am4core.Sprite);
            plane.scale = 0.15;
            plane.path = planeSVG;
      ...
      ");
            WriteLiteral(@"      originImageTemplate.setStateOnChildren = true;
     ...
     ");
            WriteLiteral(@"       // when hit on city, change lines
            ...
            var destinationHitCircle = destination");
            WriteLiteral(@"ImageTemplate.createChild(am4core.Circle);
           ...
           ");
            WriteLiteral(@" function showLines(origin) {
            ...
            graticuleSeries.mapLines.template.lin");
            WriteLiteral("e.strokeOpacity = 0.05;\r\n\r\n\r\n        }); // end am4core.ready()\r\n    </script>\r\n</section>");
        }
